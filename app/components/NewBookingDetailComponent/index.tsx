...
import { CancelBooking } from "@/app/api/Bookings";
        ...
        <View style={styles.accordianHeader}>
          ...
          >
            <CollapseHeader>
              ...
              >
                <View style={styles.rowDirection}>
                  <Image source={icons.group} style={styles.accordianIcon} />
          ...
          >
            <CollapseHeader>
              ...
              >
                <View style={styles.rowDirection}>
                  <Image source={icons.calendar} style={styles.accordianIcon} />
                  <BerlingskeMedium style={{ fontSize: vh * 1.8 }}>
                    Booking Info
                  </BerlingskeMedium>
                </View>
...
export default NewBookingDetailComponent;
