...
export type AddCarNumberPopupRef = {
  show: () => void;
  hide: () => void;
};

type AddCarNumberPopupProps = {
  reference?: RefObject<AddCarNumberPopupRef>; // Optional if passing forwardRef
  onSavePress: (name: string) => void;
};

const AddCarNumberPopup = forwardRef<
  AddCarNumberPopupRef,
  AddCarNumberPopupProps
>((props, ref) => {
      ...
      >
        ...
        <View style={styles.content}>
          <View style={styles.rowDirection}>
            <BerlingskeMedium>Add Car</BerlingskeMedium>
...
export default AddCarNumberPopup;
